...
#define RGX_GOVERNOR_PATH "/sys/devices/platform/dfrgx/devfreq/dfrgx/governor"
...
static void set_power_profile(int profile) {
    ...
    switch (profile) {
        case PROFILE_POWER_SAVE:
            sysfs_write(RGX_GOVERNOR_PATH, "powersave");
            break;
        case PROFILE_BALANCED:
            sysfs_write(RGX_GOVERNOR_PATH, "simple_ondemand");
            break;
        case PROFILE_HIGH_PERFORMANCE:
            sysfs_write(RGX_GOVERNOR_PATH, "performance");
            break;
    }
